...
namespace Nez
{
	...
	public class PrototypeSprite : Sprite
	{
        ...
        public PrototypeSprite(Vector2 offSet, float width, float height ) : this( width, height )
        {
            this.offSet = offSet;
        }
		...
		{
			var pos = ( entity.transform.position - ( origin * entity.transform.localScale ) + localOffset + this.offSet );
