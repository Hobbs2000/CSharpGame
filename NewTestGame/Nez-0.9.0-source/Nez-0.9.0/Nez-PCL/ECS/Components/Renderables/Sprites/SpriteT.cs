...
namespace Nez.Sprites
{
	...
	public class Sprite<TEnum> : Sprite, IUpdatable where TEnum : struct, IComparable, IFormattable
	{
        ...
        /// <summary>
        /// Specifically checks for animations that are not set to loop
        /// Checks if they are at their last frame, which means they are done
        /// </summary>
        public bool isPlaybackDone()
        {
            return (!_currentAnimation.loop && _currentAnimation.frames.Count - 1 == currentFrame);
        }
