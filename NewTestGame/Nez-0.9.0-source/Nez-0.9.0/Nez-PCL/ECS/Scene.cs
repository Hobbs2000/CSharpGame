...
namespace Nez
{
	public class Scene
	{
        ...
        /// 
        /// </summary>
        public Point designResolutionSize
        {
            get { return _designResolutionSize; }
            set { _designResolutionSize = value; updateResolutionScaler();}
        }
        ...
        /// <summary>
        /// Unloads all content associated with this scene and ends all the process in the scene then unloads the scene itself
        /// </summary>
        ...
        {
            return _designResolutionSize.X;
        }
        ...
        {
            return _designResolutionSize.Y;
        }
