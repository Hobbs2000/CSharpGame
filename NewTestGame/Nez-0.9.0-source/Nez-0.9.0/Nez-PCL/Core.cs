...
namespace Nez
{
	public class Core : Game
	{
        ...
        //There are used to store the different scene value so the game scene is not lost when the currentScene is switched to the UI
        Scene _uiScene;
        Scene _gameScene;
        ...
        {
            get { return _instance._gameScene; }
        ...
        {
            get { return _instance._uiScene; }
            set { _instance._uiScene = value; }
        }
        ...
        {
            get { return _instance._manager; }
            set { _instance._manager = value; }
        }
		...
		protected override void Draw( GameTime gameTime )
		{
			...
			if( _sceneTransition != null )
			{
				if( _currentScene != null && _sceneTransition.wantsPreviousSceneRender && !_sceneTransition.hasPreviousSceneRender )
				{
					_currentScene.postRender( _sceneTransition.previousSceneRender );
